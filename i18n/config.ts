...
const resources: Record<string, { common: Translations["common"] }> = {
	...
	vi: {
		common: {
			...
			description:
				"Kỹ sư phần mềm cấp cao với hơn 9 năm kinh nghiệm trong phát triển công nghệ web tiên tiến, chuyên về tối ưu hoá hiệu suất, UI/UX và kiến trúc có khả năng mở rộng. Có kinh nghiệm dẫn dắt nhóm kỹ thuật, đảm bảo chất lượng mã nguồn và hướng dẫn các nhà phát triển để nâng cao hiệu suất làm việc của đội nhóm.",
